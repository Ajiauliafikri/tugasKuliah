      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left" class="nav navbar-nav">
              <strong><h3>PT. Sri Dewi Utama</h3></strong>             
            </div> 
          </div>
            ...
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                ...
                <?php if (isset($_SESSION['CUSID'] )) { ?>  
                  <li><a href="<?php echo web_root?>index.php?q=profile"><i class="fa fa-user"></i> Akun</a></li>     
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li><a href="<?php web_root?>index.php?q=product">Produk Kami</a></li>
        ...
        <div class="col-sm-3">
          <div class="single-widget">
            ...
            <ul class="nav nav-pills nav-stacked">
              ...
              <li><a href="index.php?q=product">Produk Kami</a></li>
              <li><a href="index.php?q=contact">Kontak</a></li>
            </ul>
          </div>
        </div>
      </div>
