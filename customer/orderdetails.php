    ...
    <input type="hidden" value="<?php echo $res->AUTO; ?>" id="ORDEREDNUM" name="ORDEREDNUM">
      ...
      <div class="table-responsive cart_info"> 
              ...
              <table class="table table-condensed" id="table">
                <thead >
                <tr class="cart_menu"> 
                  <th style="width:12%; align:center; ">Produk</th>
                  <th >Deskripsi</th>
                  <th style="width:15%; align:center; ">Jumlah</th>
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Harga Produk :   Rp. <span id="sum">0.00</span></div>
                   <div > Harga Pengiriman : Rp. <span id="fee">0.00</span></div>
                   <div> Total Harga : Rp. <span id="overall"><?php echo $tot ;?></span></div>
      ...
      <div class="row">
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                      <label >
                        <input type="radio" class="paymethod" name="paymethod" id="deliveryfee" value="Transfer" checked="true" data-toggle="collapse" data-parent="#accordion" data-target="#collapseOne">Transfer
                      <img src="LOGO/bca.png" width="150px" height="150px">
                      <h5>Nomor Rekening BCA : <b>8850896331</b></h5>
                      <h5>Untuk Jumlah Transfer ditambahkan dengan order number</h5>
                      <h5>Contoh : Total Pembayaran 100.000, jika order number 0111 maka total yang harus ditransfer 100.111</h5>
                      </label>
                  </div> 
              </div> 
                        <div class="panel"> 
...
<br/>
              <div class="row">
                <div class="col-md-6">
                    <a href="index.php?q=cart" class="btn btn-default pull-left"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Lihat Keranjang</strong></a>
                   </div>
                  <div class="col-md-6">
