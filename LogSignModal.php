    ...
    <div class="modal-header">
      ...
      <div class="modal-body">
              ...
              <ul class="nav nav-pills">
                  ...
                  <li><a class="btn btn-default check_out" href="#profile" data-toggle="tab">Daftar</a>
                  </li>
                                     ...
                                     <div class="panel-body">
                                        ...
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                            <input  id="GENDER" name="GENDER" placeholder=
                                                "Gender" type="radio" checked="true" value="Male"><b> Laki-laki </b>
                                                <input   id="GENDER" name="GENDER" placeholder=
                                                "Gender" type="radio" value="Female"> <b> Perempuan </b>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                          <p>Catatan</p>
                                            Kata sandi harus minimal 8 hingga 15 karakter. Hanya huruf, angka numerik, garis bawah, dan karakter pertama yang harus berupa huruf.
                                         </div> 
                                        </div>
                                      </div> 
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          "image"></label>
                                          <div class="col-md-8">
                                            <input type="submit"  name="submit"  value="Daftar"  class="submit btn btn-pup"  />
